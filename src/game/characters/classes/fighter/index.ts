...
const data = {
    ...
    talent: { id: 'qiflow', name: '氣勢·循環', desc: '普攻命中聚氣（每隔一小段時間 +1 氣球）；每顆氣球 +8% 傷害、−5% 受傷；蓄滿 5 氣時拳速與移速顯著提升。', maxChi: 5, atkPerChi: 0.08, defPerChi: 0.05, chiThrottle: 1.5, fullHasteFactor: 1.2, fullCdRate: 1.3 },
