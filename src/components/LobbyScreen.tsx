...
import type { CharacterMeta, LobbyView } from '../types';
...
export function LobbyScreen({ lobby, status, selectedChar, onSelectChar, onStart, onLeave }: LobbyScreenProps) {
          ...
          {CHARACTERS.map((c) => (
            ...
            >
              ...
              <div className="char-skills">
                ...
                {c.ultimate && <span className="ult">; {c.ultimate.name}（大絕）</span>}
              </div>
            </button>
          ))}
        </div>
