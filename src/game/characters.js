...
export const CHARACTERS = [
  {
    ...
    basic: { name: '橫掃', type: 'melee', dmg: 26, range: 80, arc: 1.35, knockback: 180, cd: 0.55, color: '#ff6b5b', vfx: 'warrior_slash' },
  ...
  },
  {
    ...
    basic: { name: '奧術飛彈', type: 'projectile', dmg: 26, speed: 460, radius: 10, lifetime: 1.6, knockback: 60, cd: 0.6, color: '#7aa2ff', vfx: 'mage_fireball' },
    skill1: { name: '烈焰吐息', type: 'projectile', dmg: 18, speed: 540, radius: 9, lifetime: 0.45, count: 5, spread: 0.32, knockback: 40, manaCost: 45, cd: 6, color: '#ff9f43', effect: { kind: 'burn', duration: 2, tick: 0.5, dmg: 8 }, vfx: 'mage_fireball' },
    skill2: { name: '寒冰矛', type: 'projectile', dmg: 55, speed: 780, radius: 8, lifetime: 0.7, pierce: true, knockback: 50, manaCost: 45, cd: 8, color: '#74e0ff', effect: { kind: 'chill', stacks: 1, duration: 3, max: 4, freezeDur: 1.1 }, vfx: 'mage_iceshard' },
  ...
  },
  {
    ...
    basic: { name: '快刀', type: 'melee', dmg: 20, range: 58, arc: 0.95, knockback: 80, cd: 0.34, color: '#c39bd3', vfx: 'assassin_slash' },
    ...
    skill2: { name: '印記引爆', type: 'melee', dmg: 70, range: 80, arc: 1.6, knockback: 160, detonate: { mult: 2.0 }, manaCost: 35, cd: 9, color: '#e056fd', vfx: 'assassin_backstab', self: { effects: [{ kind: 'lifesteal', duration: 4, factor: 0.4 }] } },
  ...
  },
  {
    ...
    basic: { name: '重拳', type: 'melee', dmg: 18, range: 78, arc: 1.05, knockback: 280, cd: 0.62, color: '#aab7b8', vfx: 'tank_punch' },
  ...
  },
  {
    ...
    basic: { name: '射箭', type: 'projectile', dmg: 22, speed: 620, radius: 6, lifetime: 1.4, knockback: 70, cd: 0.5, color: '#2ecc71', vfx: 'archer_arrow' },
    skill1: { name: '貫穿箭', type: 'projectile', dmg: 60, speed: 920, radius: 7, lifetime: 0.9, pierce: true, knockback: 90, manaCost: 25, cd: 6, color: '#7bed9f', vfx: 'archer_arrow' },
    skill2: { name: '寄生箭', type: 'projectile', dmg: 26, speed: 560, radius: 6, lifetime: 2.0, knockback: 40, manaCost: 30, cd: 9, color: '#1abc9c', effect: { kind: 'bleed', duration: 4, tick: 0.5, dmg: 11, moveMult: 2.2 }, vfx: 'archer_arrow' },
    ultimate: { name: '萬箭齊發', type: 'projectile', dmg: 22, speed: 700, radius: 6, lifetime: 1.0, count: 8, spread: 0.12, knockback: 40, cd: 9, color: '#7bed9f', vfx: 'archer_ultimate' },
  },
  {
    ...
    basic: { name: '聖光彈', type: 'projectile', dmg: 14, speed: 420, radius: 8, lifetime: 1.2, knockback: 60, cd: 0.6, color: '#f1c40f', vfx: 'healer_holybolt' },
  ...
  },
  {
    ...
    basic: { name: '雙斧', type: 'melee', dmg: 22, range: 70, arc: 1.2, knockback: 130, cd: 0.46, lowHpBonus: true, color: '#cd6155', vfx: 'berserker_axes' },
    ...
    ultimate: { name: '血祭處決', type: 'dash', impulse: 980, dmg: 90, range: 150, arc: 7, knockback: 280, execute: { threshold: 0.25, mult: 3 }, cd: 11, color: '#ff3b2f', vfx: 'berserker_ultimate', self: { heal: 120, effects: [{ kind: 'rage', duration: 10, speed: 1.7, dmg: 1.7 }, { kind: 'lifesteal', duration: 10, factor: 0.5 }] } },
  },
  {
    ...
    basic: { name: '飛鏢', type: 'projectile', dmg: 16, speed: 640, radius: 5, lifetime: 1.0, knockback: 40, cd: 0.4, color: '#95a5a6', vfx: 'ninja_shuriken' },
    skill1: { name: '影縛符', type: 'projectile', dmg: 30, speed: 620, radius: 7, lifetime: 0.8, knockback: 30, manaCost: 25, cd: 8, color: '#636e72', effect: { kind: 'root', duration: 1.2 }, vfx: 'ninja_bind' },
  ...
  },
  {
    ...
    basic: { name: '連環拳', type: 'melee', dmg: 16, range: 58, arc: 1.05, knockback: 100, cd: 0.3, color: '#f7dc6f', vfx: 'fighter_combo' },
    skill1: { name: '上勾拳', type: 'melee', dmg: 80, range: 72, arc: 0.85, knockback: 520, manaCost: 25, cd: 6, color: '#f9e79f', vfx: 'fighter_uppercut' },
    ...
    ultimate: { name: '真·昇龍霸', type: 'dash', impulse: 900, dmg: 200, range: 110, arc: 1.4, knockback: 700, effect: { kind: 'stun', duration: 1.0 }, cd: 11, color: '#ffe27a', vfx: 'fighter_ultimate', self: { shield: 100, duration: 4 } },
  },
];
